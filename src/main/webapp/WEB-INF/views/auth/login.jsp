...
<main class="relative isolate flex min-h-screen
...
<div class="pointer-events-none absolute inset-0 -z-10">
    ...
    <div class="absolute left-1/2 top-[-250px]
                h-[500px] w-[500px]
                -translate-x-1/2
                rounded-full
                bg-sky-500/10
    ...
    <div class="absolute -left-40 top-1/3
                h-80 w-80
                rounded-full
                bg-blue-600/10
                blur-[100px]
    ...
    <div class="absolute inset-0 opacity-[0.035]"
         ...
         linear-gradient(rgba(148,163,184,.5) 1px, transparent 1px),
         linear-gradient(90deg, rgba(148,163,184,.5) 1px, transparent 1px);
...
<div class="w-full max-w-md">
        ...
        <div class="mx-auto flex h-16 w-16
            ...
            <svg
                ...
                <path
                        ...
                        stroke-width="1.6"
                        d="M12 15v2m-6 5h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v3h8z"/>
            ...
            <div class="mb-6 flex items-start gap-3
                ...
                <svg
                    ...
                    <path
                            ...
                            stroke-linejoin="round"
                            stroke-width="1.8"
                            d="M12 9v3m0 4h.01M10.29 3.86l-7.07 12a2 2 0 001.72 3h14.12a2 2 0 001.72-3l-7.07-12a2 2 0 00-3.44 0z"/>
    ...
    <p class="mt-8 text-center text-xs text-slate-700">
        ...
        © 2026 · Panel privado de administración
        ...
        if (password.type === "password") {
            ...
            icon.innerHTML = `
                ...
                <path
                    ...
                    stroke-linejoin="round"
                    stroke-width="1.6"
                    d="M9.88 4.24A9.77 9.77 0 0112 4c4.478 0 8.268 2.943 9.542 7a10.03 10.03 0 01-4.043 5.04"/>
            `;
